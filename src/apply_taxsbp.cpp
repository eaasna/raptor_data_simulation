...
// E.G.
// /project/archive-index-data/seiler/raptor_data_simulation/build/bin/apply_taxsbp --input /project/archive-index-data/RefSeqCG_arc_bac/v1/files/ --output /project/archive-index-data/RefSeqCG_arc_bac/clustering/clustering_test/ --taxsbp 1024.taxsbp --genome_update /project/archive-index-data/RefSeqCG_arc_bac/v1/updated_sequence_accession.txt --assembly_summary /project/archive-index-data/RefSeqCG_arc_bac/v1/assembly_summary.txt --threads 32
