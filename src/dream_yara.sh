...
HASH=2
THREADS=32
BINARY_DIR="/project/archive-index/seiler/dream_yara_original/build/bin" # containing the raptor binary
BIN_DIR="/project/archive-index-data/RefSeqCG_arc_bac/clustering" # directory containing the binned reference data set
BENCHMARK_DIR="/project/archive-index-data/seiler/dream_yara/original_disk_run" # directory where the benchmarks should be run. Input data will be copied here if COPY_INPUT is true. e.g. /dev/shm/username; BIN_NUMBER directory will be created.
