...
BENCHMARK_DIR="/project/archive-index-data/seiler/dream_yara/mapper_3e" # directory where the benchmarks should be run. Input data will be copied here if COPY_INPUT is true. e.g. /dev/shm/username; BIN_NUMBER directory will be created.
